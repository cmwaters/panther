...
const (
	Signer_Sign_FullMethodName      = "/consensus.v1.Signer/Sign"
	Signer_Handshake_FullMethodName = "/consensus.v1.Signer/Handshake"
)
...
type SignerClient interface {
	...
	Handshake(ctx context.Context, in *SignerHandshakeRequest, opts ...grpc.CallOption) (*SignerHandshakeResponse, error)
}
...
func (c *signerClient) Handshake(ctx context.Context, in *SignerHandshakeRequest, opts ...grpc.CallOption) (*SignerHandshakeResponse, error) {
	out := new(SignerHandshakeResponse)
	err := c.cc.Invoke(ctx, Signer_Handshake_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SignerServer interface {
	...
	Handshake(context.Context, *SignerHandshakeRequest) (*SignerHandshakeResponse, error)
...
func (UnimplementedSignerServer) Handshake(context.Context, *SignerHandshakeRequest) (*SignerHandshakeResponse, error) {
...
func _Signer_Handshake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SignerHandshakeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SignerServer).Handshake(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Signer_Handshake_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SignerServer).Handshake(ctx, req.(*SignerHandshakeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Signer_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "consensus.v1.Signer",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Signer_Handshake_Handler,
		},
	},
