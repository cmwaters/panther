...
func (c *signerClient) Sign(ctx context.Context, in *SignRequest, opts ...grpc.CallOption) (*SignResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/consensus.Signer/Sign", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *signerClient) Handshake(ctx context.Context, in *SignerHandshakeRequest, opts ...grpc.CallOption) (*SignerHandshakeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/consensus.Signer/Handshake", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Signer_Sign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/consensus.Signer/Sign",
	}
...
func _Signer_Handshake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/consensus.Signer/Handshake",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
